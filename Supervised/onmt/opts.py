...
def model_opts(parser):
    ...
    group.add_argument('-ReWE', type=bool, default=False,
                       help='Regularized training with word embeddings.')
    group.add_argument('-ReSE', type=bool, default=False,
                       help='Regularized training with sentence embeddings.')
    group.add_argument('-alpha_loss_ReWE', type=float, default=0.1,
...
def preprocess_opts(parser):
    ...
    group.add_argument('-train_src', default="WMT18/de_en/train_val/2M/train.tok.de",
                       help="Path to the training source data")
    group.add_argument('-train_tgt', default="WMT18/de_en/train_val/2M/train.tok.en",
                       help="Path to the training target data")
    group.add_argument('-valid_src', default="WMT18/de_en/train_val/val.tok.de",
                       help="Path to the validation source data")
    group.add_argument('-valid_tgt', default="WMT18/de_en/train_val/val.tok.en",
                       help="Path to the validation target data")

    group.add_argument('-src_dir', default="",
                       help="Source directory for image or audio files.")

    group.add_argument('-save_data', default="WMT18/de_en/2M.TOKENIZED.100l",
...
def train_opts(parser):
    ...
    #Neubig Style training options
    group.add_argument('-neubig_style_training', default=False,
                       help="""Apply the same adam annealing algorithm that
                       Denkowski and Neubig apply in their paper. This includes
                       applying validation every -validation_freq_every_X_batch times""")

    group.add_argument('-validation_freq_every_X_batch', default=625,
                       help="""Apply the same adam annealing algorithm that
                           Denkowski and Neubig apply in their paper. This includes
                           applying validation every -validation_freq times""")
    ...
    group.add_argument('-batch_size', type=int, default=40,
    ...
    group.add_argument('-learning_rate_decay', type=float, default=0.5,
                       ...
                       start_decay_at""")
    group.add_argument('-start_decay_at', type=int, default=50,
