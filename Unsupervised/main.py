...
#--eval_only True --reload_model dumped/test/xxx/best-bleu_en_fr_valid.pth --reload_enc True --reload_dec True
...
parser.add_argument("--lambda_ReWE_mono", type=float, default="20",
                    help="ReWE reconstruction coefficient (autoencoding)")
...
parser.add_argument("--lambda_ReWE_otfd", type=float, default="20",
                    help="ReWE reconstruction coefficient (on-the-fly back-translation parallel data)")
parser.add_argument("--lambda_ReSE_otfd", type=float, default="20",
                    help="ReSE reconstruction coefficient (on-the-fly back-translation parallel data)")
...
parser.add_argument("--ReWE_mono", type=bool, default=False,
                    help="Regressing word embeddings as regularizer (monolingual)")
parser.add_argument("--ReWE_otfd", type=bool, default=False,
                    help="Regressing word embeddings as regularizer (on-the-fly backtranslation")
parser.add_argument("--ReSE_otfd", type=bool, default=False,
                    help="Regressing sentence embeddings as regularizer (on-the-fly backtranslation")
        ...
        while trainer.n_sentences < params.epoch_size:
            ...
            if params.lambda_xe_mono > 0:
                for lang in params.mono_directions:
                    if params.ReWE_mono:
                        trainer.enc_dec_step(lang, lang, params.lambda_xe_mono,params.lambda_ReWE_mono,type_train='mono')
                    else:
                        trainer.enc_dec_step(lang, lang, params.lambda_xe_mono,type_train='mono')
            ...
            if params.lambda_xe_otfd > 0 or params.lambda_xe_otfa > 0:
                ...
                for batch in batches:
                    ...
                    # 2-lang back-translation - parallel data
                        ...
                        if params.ReWE_otfd and not params.ReSE_otfd:
                            trainer.otf_bt(batch, params.lambda_xe_otfd, params.otf_backprop_temperature, lambda_ReWE= params.lambda_ReWE_otfd,
                                           type_train='otfd')
                        elif not params.ReWE_otfd and params.ReSE_otfd:
                            trainer.otf_bt(batch, params.lambda_xe_otfd, params.otf_backprop_temperature, lambda_ReSE= params.lambda_ReSE_otfd,
                                           type_train='otfd')
                        elif params.ReWE_otfd and params.ReSE_otfd:
                            trainer.otf_bt(batch, params.lambda_xe_otfd, params.otf_backprop_temperature, lambda_ReWE= params.lambda_ReWE_otfd,
                                           lambda_ReSE=params.lambda_ReSE_otfd ,type_train='otfd')
                        else:
                            trainer.otf_bt(batch, params.lambda_xe_otfd, params.otf_backprop_temperature,type_train='otfd')
