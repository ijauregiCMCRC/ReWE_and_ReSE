...
def check_mt_model_params(params):
    ...
    print (params.reload_enc or params.reload_dec or params.reload_dis)
    print ((params.reload_model != '') ^ (params.reload_enc or params.reload_dec or params.reload_dis))
